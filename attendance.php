	...
	<div class="row">
		...
		<div class="col-sm-8 col-sm-offset-2">
           ...
           <strong>Date :</strong><?php $cur_date=date('d-m-Y');echo $cur_date; ?>
			...
			<div class="row">
                <form class="" action="store_attendance.php" method="post">
                    ...
                    <input type="submit"class="btn btn-success"id="subm" name="submitattendance" value="Save Attendance">
                </form>    
			</div>
		</div>
	</div>
